...
/***/ function(module, exports, __webpack_require__) {
	...
	var profanity = function () {
	  ...
	  _createClass(profanity, [{
	    key: 'makeUrl',
	    value: function makeUrl(locale) {
	      if (this.localesUrlMockup !== null) {
	        return this.localesUrlMockup.replace(/\[locale\]/gi, locale);
	      } else {
	        (0, _logger2.default)('Locale provided is null');
	      }
	    }
	    ...
	    value: function addLocales() {
	      ...
	      if (locales.length) {
	        locales.filter(function (locale) {
	          ...
	          var url = _this.makeUrl(locale);console.log(url);
