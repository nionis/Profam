...
/***/ function(module, exports, __webpack_require__) {
	...
	var profanity = function () {
	  function profanity() {
	    ...
	    ['grawlix', { 'enabled': 1 }], ['obscure', { 'enabled': 0 }], ['choice', { 'enabled': 0 }], ['grawlix', { 'enabled': 0 }], ['asterisks', { 'enabled': 0 }], ['spaces', { 'enabled': 0 }], ['black', { 'enabled': 0 }]]);
	  ...
	  _createClass(profanity, [{
	    ...
	    value: function clean() {
	      ...
	      var toReturn = strings.map(function (string) {
	        ...
	        //localeAllWords, modeElected, string
	        localeAllWords.forEach(function (word) {
	          if (string.indexOf(word) !== -1) {
	            var wordLength = word.length;
	            var replaceStr = function (mode, wordLength) {
	              switch (modeElected) {
	                case 'spaces':
	                  {
	            ...
	            return string.replace(new RegExp(word, 'gi'), replaceStr);
	          } else {
	            return string;
	          }
	        });
