...
/***/ function(module, exports, __webpack_require__) {
	...
	var profanity = function () {
	  function profanity() {
	    ...
	    ['choice', { 'enabled': 0, data: [] }], ['funny', { 'enabled': 0, data: [] }], ['grawlix', { 'enabled': 0 }], ['asterisks-obscure', { 'enabled': 0 }], ['asterisks-full', { 'enabled': 0 }], ['grawlix', { 'enabled': 0 }], ['spaces', { 'enabled': 0 }], ['black', { 'enabled': 0 }], ['hide', { 'enabled': 0 }], ['bleep', { 'enabled': 0 }]]);
	  ...
	  _createClass(profanity, [{
	    ...
	    value: function proceed() {
	            ...
	            (function () {
	              ...
	              var replaceStr = function () {
	                switch (modeElected) {
	                  ...
	                  case 'choice':
	                    {
	                      var choices = _this3.modes.get('choice').data;
	                      return choices[(0, _utils.randomRange)(0, choices.length)] || '';
	                    }
	                  //asterisks-obscure
	                  default:
	                    {
	              ...
	              // string = string.replace(new RegExp('\\b'+ word + '\\b', 'gi'), replaceStr);
	            })();
	          }
	        });
	      ...
	      var whatIsReturn = (0, _utils.whatIs)(toReturn);
