...
/***/ function(module, exports, __webpack_require__) {
	...
	var profanity = function () {
	  function profanity() {
	    ...
	    ['choice', { 'enabled': 0, data: [] }], ['grawlix', { 'enabled': 0 }], ['asterisks-obscure', { 'enabled': 0 }], ['asterisks-full', { 'enabled': 0 }], ['grawlix', { 'enabled': 0 }], ['spaces', { 'enabled': 0 }], ['black', { 'enabled': 0 }], ['bleep', { 'enabled': 0 }]]);
