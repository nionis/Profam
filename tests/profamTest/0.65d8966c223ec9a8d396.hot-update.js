...
/***/ function(module, exports, __webpack_require__) {
	...
	var profanity = function () {
	  function profanity() {
	    ...
	    ['grawlix', { 'enabled': 1 }], ['obscure', { 'enabled': 0 }], ['choice', { 'enabled': 0 }], ['grawlix', { 'enabled': 0 }], ['asterisks', { 'enabled': 0 }], ['spaces', { 'enabled': 0 }], ['black', { 'enabled': 0 }], ['bleep', { 'enabled': 0 }]]);
	                  ...
	                  case 'grawlix':
	                    {
	                      return word.split('').map(function (char) {
	                        return ['!', '@', '#', '$', '%', '&', '*'][(0, _utils.randomRange)(0, grawlixChars.length)];
	                      }).join('');
	                    }
